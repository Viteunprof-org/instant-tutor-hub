...
function CheckoutForm({ clientSecret, amount, onSuccess, onError, packName, credits }: CheckoutFormProps) {
...
export default function StripeCheckout({ clientSecret, amount, onSuccess, onError, packName, credits }: StripeCheckoutProps) {
  const appearance = {
  ...
  return (
    <Elements stripe={stripePromise} options={options}>
      <CheckoutForm clientSecret={clientSecret} amount={amount} onSuccess={onSuccess} onError={onError} packName={packName} credits={credits} />
    </Elements>
  );
}
