  ...
  return (
    <Card className="w-full max-w-md">
      ...
      <CardContent className="space-y-4">
        <Button onClick={() => onSelectUserType("student")} className="w-full h-12 bg-vup-yellow text-vup-navy hover:bg-vup-yellow/90 font-medium">
          Je suis élève
        </Button>
        <Button onClick={() => onSelectUserType("parent")} className="w-full h-12 bg-vup-navy text-white hover:bg-vup-navy/90 font-medium">
          Je suis parent
        </Button>
