...
export default function TeacherBasicInfoStep({ type, data, onDataChange, onNext, onBack, isValid }: TeacherBasicInfoStepProps) {
  const isStudentTeacher = type === "teacher";
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardTitle className="text-center text-xl">Informations personnelles</CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="lastName" type="text" value={data.lastName} onChange={(e) => onDataChange("lastName", e.target.value)} placeholder="Votre nom" />
        </div>
