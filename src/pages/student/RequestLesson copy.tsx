  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Any final state updates can go here
      }
    };
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  {matters.map((subject) => (
                    <button
                      ...
                      className={`p-4 border rounded-lg text-center transition-colors ${
                        selectedSubject === subject.id ? "border-vup-yellow bg-vup-yellow/10" : "border-gray-200 hover:border-gray-300"
                      }`}
                    >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Combien de temps souhaitez-vous étudier ?</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {durations.map((d) => (
                    <button
                      ...
                      className={`p-4 border rounded-lg text-left transition-colors ${
                        duration === d.value ? "border-vup-yellow bg-vup-yellow/10" : "border-gray-200 hover:border-gray-300"
                      }`}
                    >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Quand avez-vous besoin de ce cours ?</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {urgencyLevels.map((level) => (
                    <button
                      ...
                      className={`w-full p-4 border rounded-lg text-left transition-colors ${
                        urgency === level.value ? "border-vup-yellow bg-vup-yellow/10" : "border-gray-200 hover:border-gray-300"
                      }`}
                    >
                  ...
                  {/* Date/Time picker appears below all urgency buttons */}
                  {urgency && (urgency === "low" || urgency === "medium") && (
                ...
                <CardContent>
                  <div className="space-y-2 mb-6">
                    <div className="flex justify-between">
                      <span>Matière :</span>
                      <span className="font-medium">{matters.find((s) => s.id === selectedSubject)?.name}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Durée :</span>
                    ...
                    <div className="flex justify-between">
                      ...
                      <div className="text-right">
                        <Badge className={selectedUrgencyLevel?.color}>{selectedUrgencyLevel?.label}</Badge>
                  ...
                  <Button type="submit" className="w-full bg-vup-yellow text-vup-navy hover:bg-vup-yellow/90" disabled={isSubmitting}>
                    {isSubmitting ? (
                      <>
